...
import { BaseTypography } from '../../template/style/base_typography';

export class BaseTypographyFile extends BaseFile {
    ...
    create(): void {
        const result = new BaseTypography(this.getFileName, '');
