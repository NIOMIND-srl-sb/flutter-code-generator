...
import { DataUiState } from '../../../template/ui/data/ui_state';

export class DataUiStateFile extends BaseFile {
    ...
    create(): void {
        const baseModel = new DataUiState(this.folders !== undefined ? this.folders![0] : this.getFileName, '');
        this.createFiles(
            this.pathValue,
            this.getFileName,
