...
import { DataViewModel } from '../../../template/ui/data/view_model';

export class DataViewModelFile extends BaseFile {
    ...
    create(): void {
        const baseModel = new DataViewModel(this.folders !== undefined ? this.folders![0] : this.getFileName, '');
        this.createFiles(
            this.pathValue,
            this.getFileName,
