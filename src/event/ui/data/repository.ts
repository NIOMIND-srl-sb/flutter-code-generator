...
import { DataRepository } from '../../../template/ui/data/repository';

export class DataRepositoryFile extends BaseFile {
    ...
    create(): void {
        const baseModel = new DataRepository(this.folders !== undefined ? this.folders![0] : this.getFileName, '');
        this.createFiles(
            this.pathValue,
            this.getFileName,
