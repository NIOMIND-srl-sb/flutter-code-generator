...
import { ListDataUiState } from '../../../template/ui/listData/ui_state';

export class ListDataUiStateFile extends BaseFile {
    ...
    create(): void {
        const baseModel = new ListDataUiState(this.folders !== undefined ? this.folders![0] : this.getFileName, '');
        this.createFiles(
            this.pathValue,
            this.getFileName,
