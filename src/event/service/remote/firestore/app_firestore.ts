...
import { AppFirestore } from '../../../../template/service/remote/firestore/app_firestore';

export class AppFirestoreFile extends BaseFile {
    ...
    create(): void {
        const baseModel = new AppFirestore(this.getFileName, '');
        this.createFiles(
            this.pathValue,
            this.getFileName,
