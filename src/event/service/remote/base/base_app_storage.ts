...
import { BaseAppStorage } from '../../../../template/service/remote/base/base_app_storage';

export class BaseAppStorageFile extends BaseFile {
    ...
    create(): void {
        const baseModel = new BaseAppStorage(this.getFileName, '');
        this.createFiles(
            this.pathValue,
            this.getFileName,
