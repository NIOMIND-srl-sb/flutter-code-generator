...
export class ListDataRepository extends BaseTemplate {
...
class ${this.className}Repository extends Base${this.className}Repository {
  ...
  final _streamControllerListData = StreamController<List<dynamic>>.broadcast();
  ...
  @override
  Stream<List<dynamic>> get streamListData => _streamControllerListData.stream;
  ...
  @override
  void close() {
    _streamControllerListData.close();
  }
}`;
    }
